...
public class DataStudent {
   ...
   static{
        ...
        //high-school data
        list.add(new StudentHighSchool(1,"Nguyen Van A" ,16,7.8,5.5,7.2,8.1));
        list.add(new StudentHighSchool(2,"Nguyen Van b" ,16,7.8,5.5,7.2,8.1));
        list.add(new StudentHighSchool(3,"Nguyen Van C" ,16,7.8,5.5,7.2,8.1));
        list.add(new StudentHighSchool(4,"Nguyen Van d" ,16,7.8,5.5,7.2,8.1));
        list.add(new StudentHighSchool(5,"Nguyen Van e" ,16,7.8,5.5,7.2,8.1));
        list.add(new StudentHighSchool(6,"Nguyen Van f" ,16,7.8,5.5,7.2,8.1));
    }
